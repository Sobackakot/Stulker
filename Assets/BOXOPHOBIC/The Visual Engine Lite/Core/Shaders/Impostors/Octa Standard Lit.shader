	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				TVEModelData Data16_g157130 = (TVEModelData)0;
				float In_Dummy16_g157130 = 0.0;
				OctaImpostorVertex( inputMesh.positionOS, inputMesh.normalOS, outputPackedVaryingsMeshToPS.UVsFrame122_g156801, outputPackedVaryingsMeshToPS.UVsFrame222_g156801, outputPackedVaryingsMeshToPS.UVsFrame322_g156801, outputPackedVaryingsMeshToPS.octaframe22_g156801, outputPackedVaryingsMeshToPS.viewPos22_g156801 );
				float3 worldPosOut22_g156801 = GetAbsolutePositionWS( mul( UNITY_MATRIX_I_V, float4( outputPackedVaryingsMeshToPS.viewPos22_g156801.xyz, 1.0 ) ).xyz );
				half3 Input_PositionWS218_g157123 = worldPosOut22_g156801;
				float3 worldToObj278_g157123 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(Input_PositionWS218_g157123), 1 ) ).xyz;
				half3 Model_PositionOS131_g157123 = worldToObj278_g157123;
				float3 In_PositionOS16_g157130 = Model_PositionOS131_g157123;
				half3 Model_PositionWS122_g157123 = Input_PositionWS218_g157123;
				float3 In_PositionWS16_g157130 = Model_PositionWS122_g157123;
				half3 Model_PositionWO132_g157123 = ( Model_PositionWS122_g157123 - TVE_WorldOrigin );
				float3 In_PositionWO16_g157130 = Model_PositionWO132_g157123;
				float3 In_PositionRawOS16_g157130 = Model_PositionOS131_g157123;
				float3 In_PositionAddOS16_g157130 = float3( 0,0,0 );
				float3 In_PivotOS16_g157130 = float3( 0,0,0 );
				float3 localObjectPosition_UNITY_MATRIX_M14_g157125 = ObjectPosition_UNITY_MATRIX_M();
				#ifdef SHADEROPTIONS_CAMERA_RELATIVE_RENDERING
				float3 staticSwitch13_g157125 = ( localObjectPosition_UNITY_MATRIX_M14_g157125 + _WorldSpaceCameraPos );
				#else
				float3 staticSwitch13_g157125 = localObjectPosition_UNITY_MATRIX_M14_g157125;
				#endif
				half3 ObjectData20_g157127 = staticSwitch13_g157125;
				float3 ase_worldPos = GetAbsolutePositionWS( TransformObjectToWorld( (inputMesh.positionOS).xyz ) );
				half3 WorldData19_g157127 = ase_worldPos;
				#ifdef TVE_OBJECT_BATCHED
				float3 staticSwitch14_g157127 = WorldData19_g157127;
				#else
				float3 staticSwitch14_g157127 = ObjectData20_g157127;
				#endif
				float3 temp_output_124_0_g157125 = staticSwitch14_g157127;
				float3 vertexToFrag281_g157123 = temp_output_124_0_g157125;
				half3 Model_PivotWS121_g157123 = vertexToFrag281_g157123;
				float3 In_PivotWS16_g157130 = Model_PivotWS121_g157123;
				half3 Model_PivotWO133_g157123 = ( Model_PivotWS121_g157123 - TVE_WorldOrigin );
				float3 In_PivotWO16_g157130 = Model_PivotWO133_g157123;
				half3 Model_NormalOS134_g157123 = inputMesh.normalOS;
				float3 In_NormalOS16_g157130 = Model_NormalOS134_g157123;
				float3 ase_worldNormal = TransformObjectToWorldNormal(inputMesh.normalOS);
				half3 Model_Normal_WS95_g157123 = ase_worldNormal;
				float3 In_NormalWS16_g157130 = Model_Normal_WS95_g157123;
				float3 In_NormalRawOS16_g157130 = Model_NormalOS134_g157123;
				float3 In_NormalRawWS16_g157130 = Model_Normal_WS95_g157123;
				float4 In_TangentOS16_g157130 = float4( 0,1,0,1 );
				float3 normalizeResult326_g157123 = normalize( ( _WorldSpaceCameraPos - Model_PositionWS122_g157123 ) );
				half3 Model_ViewDirWS322_g157123 = normalizeResult326_g157123;
				float3 In_ViewDirWS16_g157130 = Model_ViewDirWS322_g157123;
				float4 In_VertexData16_g157130 = float4( 1,1,1,1 );
				float4 In_MotionData16_g157130 = float4( 0,0,0,0 );
				float4 In_BoundsData16_g157130 = float4( 1,1,1,1 );
				float4 In_RotationData16_g157130 = float4( 0,0,0,0 );
				Data16_g157130.Dummy = In_Dummy16_g157130;
				Data16_g157130.PositionOS = In_PositionOS16_g157130;
				Data16_g157130.PositionWS = In_PositionWS16_g157130;
				Data16_g157130.PositionWO = In_PositionWO16_g157130;
				Data16_g157130.PositionRawOS = In_PositionRawOS16_g157130;
				Data16_g157130.PositionAddOS = In_PositionAddOS16_g157130;
				Data16_g157130.PivotOS = In_PivotOS16_g157130;
				Data16_g157130.PivotWS = In_PivotWS16_g157130;
				Data16_g157130.PivotWO = In_PivotWO16_g157130;
				Data16_g157130.NormalOS = In_NormalOS16_g157130;
				Data16_g157130.NormalWS = In_NormalWS16_g157130;
				Data16_g157130.NormalRawOS = In_NormalRawOS16_g157130;
				Data16_g157130.NormalRawWS = In_NormalRawWS16_g157130;
				Data16_g157130.TangentOS = In_TangentOS16_g157130;
				Data16_g157130.ViewDirWS = In_ViewDirWS16_g157130;
				Data16_g157130.VertexData = In_VertexData16_g157130;
				Data16_g157130.MotionData = In_MotionData16_g157130;
				Data16_g157130.BoundsData = In_BoundsData16_g157130;
				Data16_g157130.RotationData = In_RotationData16_g157130;
				TVEModelData Data15_g158263 = Data16_g157130;
				...
				TVEModelData Data15_g158312 = Data16_g158299;
				float Out_Dummy15_g158312 = 0;
				float3 Out_PositionOS15_g158312 = float3( 0,0,0 );
				float3 Out_PositionWS15_g158312 = float3( 0,0,0 );
				float3 Out_PositionWO15_g158312 = float3( 0,0,0 );
				float3 Out_PositionRawOS15_g158312 = float3( 0,0,0 );
				float3 Out_PositionAddOS15_g158312 = float3( 0,0,0 );
				float3 Out_PivotOS15_g158312 = float3( 0,0,0 );
				float3 Out_PivotWS15_g158312 = float3( 0,0,0 );
				float3 Out_PivotWO15_g158312 = float3( 0,0,0 );
				float3 Out_NormalOS15_g158312 = float3( 0,0,0 );
				float3 Out_NormalWS15_g158312 = float3( 0,0,0 );
				float3 Out_NormalRawOS15_g158312 = float3( 0,0,0 );
				float3 Out_NormalRawWS15_g158312 = float3( 0,0,0 );
				float4 Out_TangentOS15_g158312 = float4( 0,0,0,0 );
				float3 Out_ViewDirWS15_g158312 = float3( 0,0,0 );
				float4 Out_VertexData15_g158312 = float4( 0,0,0,0 );
				float4 Out_MotionData15_g158312 = float4( 0,0,0,0 );
				float4 Out_BoundsData15_g158312 = float4( 0,0,0,0 );
				float4 Out_RotationData15_g158312 = float4( 0,0,0,0 );
				Out_Dummy15_g158312 = Data15_g158312.Dummy;
				Out_PositionOS15_g158312 = Data15_g158312.PositionOS;
				Out_PositionWS15_g158312 = Data15_g158312.PositionWS;
				Out_PositionWO15_g158312 = Data15_g158312.PositionWO;
				Out_PositionRawOS15_g158312 = Data15_g158312.PositionRawOS;
				Out_PositionAddOS15_g158312 = Data15_g158312.PositionAddOS;
				Out_PivotOS15_g158312 = Data15_g158312.PivotOS;
				Out_PivotWS15_g158312 = Data15_g158312.PivotWS;
				Out_PivotWO15_g158312 = Data15_g158312.PivotWO;
				Out_NormalOS15_g158312 = Data15_g158312.NormalOS;
				Out_NormalWS15_g158312 = Data15_g158312.NormalWS;
				Out_NormalRawOS15_g158312 = Data15_g158312.NormalRawOS;
				Out_NormalRawWS15_g158312 = Data15_g158312.NormalRawWS;
				Out_TangentOS15_g158312 = Data15_g158312.TangentOS;
				Out_ViewDirWS15_g158312 = Data15_g158312.ViewDirWS;
				Out_VertexData15_g158312 = Data15_g158312.VertexData;
				Out_MotionData15_g158312 = Data15_g158312.MotionData;
				Out_BoundsData15_g158312 = Data15_g158312.BoundsData;
				Out_RotationData15_g158312 = Data15_g158312.RotationData;
				float3 temp_output_31_0_g158305 = Out_PositionOS15_g158312;
				float3 temp_output_6_0_g158319 = ( ( temp_output_31_0_g158305 - Out_PositionRawOS15_g158312 ) + _DisableSRPBatcher );
				...
				#ifdef TVE_REGISTER
				float4 staticSwitch14_g158319 = ( float4( temp_output_6_0_g158319 , 0.0 ) + ( Dummy_Data433 * float4( 0,0,0,0 ) ) );
				#else
				float4 staticSwitch14_g158319 = float4( temp_output_6_0_g158319 , 0.0 );
				#endif
				
				outputPackedVaryingsMeshToPS.ase_texcoord11.xyz = vertexToFrag281_g157123;
				...
				inputMesh.positionOS.xyz += staticSwitch14_g158319.rgb;
			...
			void Frag(  PackedVaryingsMeshToPS packedInput,	OUTPUT_GBUFFER(outGBuffer), out float outputDepth : SV_Depth  )
			{
				...
				float localBreakData4_g158308 = ( 0.0 );
				...
				float localCompData3_g157198 = ( 0.0 );
				TVEVisualData Data3_g157198 = (TVEVisualData)0;
				float4 output0 = 0;
				float4 output1 = 0;
				OctaImpostorFragment( o, positionCS, positionWS, packedInput.UVsFrame122_g156801, packedInput.UVsFrame222_g156801, packedInput.UVsFrame322_g156801, packedInput.octaframe22_g156801, packedInput.viewPos22_g156801, output0, output1 );
				float In_Dummy3_g157198 = output1.r;
				float4 break227_g157197 = output0;
				half Local_MultiMask249_g157197 = break227_g157197.b;
				float lerpResult289_g157197 = lerp( 1.0 , Local_MultiMask249_g157197 , _ImpostorColorMode);
				float3 lerpResult292_g157197 = lerp( (_ImpostorColorTwo).rgb , (_ImpostorColor).rgb , lerpResult289_g157197);
				half3 Local_Albedo239_g157197 = ( o.Albedo * lerpResult292_g157197 );
				float3 In_Albedo3_g157198 = Local_Albedo239_g157197;
				float2 temp_cast_4 = (0.5).xx;
				float2 In_NormalTS3_g157198 = temp_cast_4;
				float3 In_NormalWS3_g157198 = o.Normal;
				half Local_Metallic247_g157197 = break227_g157197.r;
				half Final_Metallic238_g157197 = ( Local_Metallic247_g157197 * _ImpostorMetallicValue );
				half Local_Smoothness250_g157197 = break227_g157197.a;
				half Final_Smoothness233_g157197 = ( Local_Smoothness250_g157197 * _ImpostorSmoothnessValue );
				float4 appendResult257_g157197 = (float4(Final_Metallic238_g157197 , 1.0 , 1.0 , Final_Smoothness233_g157197));
				float4 In_Shader3_g157198 = appendResult257_g157197;
				half Local_EmissiveMask248_g157197 = break227_g157197.g;
				float4 appendResult286_g157197 = (float4(Local_EmissiveMask248_g157197 , Local_EmissiveMask248_g157197 , Local_EmissiveMask248_g157197 , 1.0));
				float4 In_Emissive3_g157198 = appendResult286_g157197;
				float3 temp_output_3_0_g157199 = Local_Albedo239_g157197;
				float dotResult20_g157199 = dot( temp_output_3_0_g157199 , float3(0.2126,0.7152,0.0722) );
				half Local_Grayscale268_g157197 = dotResult20_g157199;
				float In_Grayscale3_g157198 = Local_Grayscale268_g157197;
				float clampResult267_g157197 = clamp( saturate( ( Local_Grayscale268_g157197 * 5.0 ) ) , 0.2 , 1.0 );
				half Local_Luminosity269_g157197 = clampResult267_g157197;
				float In_Luminosity3_g157198 = Local_Luminosity269_g157197;
				float In_MultiMask3_g157198 = Local_MultiMask249_g157197;
				float In_AlphaClip3_g157198 = 0.0;
				float In_AlphaFade3_g157198 = 1.0;
				float3 temp_cast_5 = (1.0).xxx;
				float3 In_Translucency3_g157198 = temp_cast_5;
				float In_Transmission3_g157198 = 1.0;
				float In_Thickness3_g157198 = 0.0;
				float In_Diffusion3_g157198 = 0.0;
				Data3_g157198.Dummy = In_Dummy3_g157198;
				Data3_g157198.Albedo = In_Albedo3_g157198;
				Data3_g157198.NormalTS = In_NormalTS3_g157198;
				Data3_g157198.NormalWS = In_NormalWS3_g157198;
				Data3_g157198.Shader = In_Shader3_g157198;
				Data3_g157198.Emissive= In_Emissive3_g157198;
				Data3_g157198.MultiMask = In_MultiMask3_g157198;
				Data3_g157198.Grayscale = In_Grayscale3_g157198;
				Data3_g157198.Luminosity = In_Luminosity3_g157198;
				Data3_g157198.AlphaClip = In_AlphaClip3_g157198;
				Data3_g157198.AlphaFade = In_AlphaFade3_g157198;
				Data3_g157198.Translucency = In_Translucency3_g157198;
				Data3_g157198.Transmission = In_Transmission3_g157198;
				Data3_g157198.Thickness = In_Thickness3_g157198;
				Data3_g157198.Diffusion = In_Diffusion3_g157198;
				TVEVisualData Data4_g158218 = Data3_g157198;
				...
				float localBuildGlobalData204_g157132 = ( 0.0 );
				TVEGlobalData Data204_g157132 = (TVEGlobalData)0;
				half Dummy211_g157132 = ( _GlobalLiteInfo + ( _GlobalCategory + _GlobalEnd ) );
				float In_Dummy204_g157132 = Dummy211_g157132;
				float4 temp_output_362_164_g157132 = TVE_CoatParams;
				half4 Coat_Params302_g157132 = temp_output_362_164_g157132;
				float4 In_CoatParams204_g157132 = Coat_Params302_g157132;
				float4 temp_output_361_164_g157132 = TVE_PaintParams;
				half4 Paint_Params71_g157132 = temp_output_361_164_g157132;
				float4 In_PaintParams204_g157132 = Paint_Params71_g157132;
				float4 temp_output_365_163_g157132 = TVE_GlowParams;
				half4 Glow_Params248_g157132 = temp_output_365_163_g157132;
				float4 In_GlowParams204_g157132 = Glow_Params248_g157132;
				float4 temp_output_363_141_g157132 = TVE_AtmoParams;
				half4 Atmo_Params80_g157132 = temp_output_363_141_g157132;
				float4 In_AtmoParams204_g157132 = Atmo_Params80_g157132;
				float4 temp_output_364_139_g157132 = TVE_FormParams;
				half4 Form_Params112_g157132 = temp_output_364_139_g157132;
				float4 In_FormParams204_g157132 = Form_Params112_g157132;
				float4 temp_output_366_145_g157132 = TVE_WindParams;
				half4 Wind_Params88_g157132 = temp_output_366_145_g157132;
				float4 In_WindParams204_g157132 = Wind_Params88_g157132;
				float4 temp_output_367_145_g157132 = TVE_PushParams;
				half4 Push_Params335_g157132 = temp_output_367_145_g157132;
				float4 In_PushParams204_g157132 = Push_Params335_g157132;
				Data204_g157132.Dummy = In_Dummy204_g157132;
				Data204_g157132.CoatParams = In_CoatParams204_g157132;
				Data204_g157132.PaintParams = In_PaintParams204_g157132;
				Data204_g157132.GlowParams = In_GlowParams204_g157132;
				Data204_g157132.AtmoParams = In_AtmoParams204_g157132;
				Data204_g157132.FormParams= In_FormParams204_g157132;
				Data204_g157132.WindParams = In_WindParams204_g157132;
				Data204_g157132.PushParams = In_PushParams204_g157132;
				TVEGlobalData Data15_g158219 = Data204_g157132;
				...
				TVEGlobalData Data15_g158249 = Data204_g157132;
				...
				TVEGlobalData Data15_g158294 = Data204_g157132;
				...
				TVEModelData Data16_g157131 = (TVEModelData)0;
				float In_Dummy16_g157131 = 0.0;
				float3 In_PositionOS16_g157131 = float3( 0,0,0 );
				half3 Input_PositionWS218_g157123 = GetAbsolutePositionWS( positionWS );
				half3 Model_PositionWS122_g157123 = Input_PositionWS218_g157123;
				float3 In_PositionWS16_g157131 = Model_PositionWS122_g157123;
				half3 Model_PositionWO132_g157123 = ( Model_PositionWS122_g157123 - TVE_WorldOrigin );
				float3 In_PositionWO16_g157131 = Model_PositionWO132_g157123;
				float3 In_PositionRawOS16_g157131 = float3( 0,0,0 );
				float3 In_PositionAddOS16_g157131 = float3( 0,0,0 );
				float3 In_PivotOS16_g157131 = float3( 0,0,0 );
				float3 vertexToFrag281_g157123 = packedInput.ase_texcoord11.xyz;
				half3 Model_PivotWS121_g157123 = vertexToFrag281_g157123;
				float3 In_PivotWS16_g157131 = Model_PivotWS121_g157123;
				half3 Model_PivotWO133_g157123 = ( Model_PivotWS121_g157123 - TVE_WorldOrigin );
				float3 In_PivotWO16_g157131 = Model_PivotWO133_g157123;
				float3 In_NormalOS16_g157131 = float3( 0,0,0 );
				half3 Model_Normal_WS95_g157123 = packedInput.interp01;
				float3 In_NormalWS16_g157131 = Model_Normal_WS95_g157123;
				float3 In_NormalRawOS16_g157131 = float3( 0,0,0 );
				float3 In_NormalRawWS16_g157131 = float3( 0,0,0 );
				float4 In_TangentOS16_g157131 = float4( 0,1,0,1 );
				float3 normalizeResult326_g157123 = normalize( ( _WorldSpaceCameraPos - Model_PositionWS122_g157123 ) );
				half3 Model_ViewDirWS322_g157123 = normalizeResult326_g157123;
				float3 In_ViewDirWS16_g157131 = Model_ViewDirWS322_g157123;
				float4 In_VertexData16_g157131 = float4( 1,1,1,1 );
				float4 In_MotionData16_g157131 = float4( 0,0,0,0 );
				float4 In_BoundsData16_g157131 = float4( 1,1,1,1 );
				float4 In_RotationData16_g157131 = float4( 0,0,0,0 );
				Data16_g157131.Dummy = In_Dummy16_g157131;
				Data16_g157131.PositionOS = In_PositionOS16_g157131;
				Data16_g157131.PositionWS = In_PositionWS16_g157131;
				Data16_g157131.PositionWO = In_PositionWO16_g157131;
				Data16_g157131.PositionRawOS = In_PositionRawOS16_g157131;
				Data16_g157131.PositionAddOS = In_PositionAddOS16_g157131;
				Data16_g157131.PivotOS = In_PivotOS16_g157131;
				Data16_g157131.PivotWS = In_PivotWS16_g157131;
				Data16_g157131.PivotWO = In_PivotWO16_g157131;
				Data16_g157131.NormalOS = In_NormalOS16_g157131;
				Data16_g157131.NormalWS = In_NormalWS16_g157131;
				Data16_g157131.NormalRawOS = In_NormalRawOS16_g157131;
				Data16_g157131.NormalRawWS = In_NormalRawWS16_g157131;
				Data16_g157131.TangentOS = In_TangentOS16_g157131;
				Data16_g157131.ViewDirWS = In_ViewDirWS16_g157131;
				Data16_g157131.VertexData = In_VertexData16_g157131;
				Data16_g157131.MotionData = In_MotionData16_g157131;
				Data16_g157131.BoundsData = In_BoundsData16_g157131;
				Data16_g157131.RotationData = In_RotationData16_g157131;
				TVEModelData Data15_g158293 = Data16_g157131;
				...
				#ifdef TVE_SUBSURFACE
				float staticSwitch351_g158290 = _SubsurfaceThicknessValue;
				#else
				...
				TVEVisualData Data4_g158308 = Data3_g158292;
				float Out_Dummy4_g158308 = 0;
				float3 Out_Albedo4_g158308 = float3( 0,0,0 );
				float2 Out_NormalTS4_g158308 = float2( 0,0 );
				float3 Out_NormalWS4_g158308 = float3( 0,0,0 );
				float4 Out_Shader4_g158308 = float4( 0,0,0,0 );
				float4 Out_Emissive4_g158308 = float4( 0,0,0,0 );
				float Out_MultiMask4_g158308 = 0;
				float Out_Grayscale4_g158308 = 0;
				float Out_Luminosity4_g158308 = 0;
				float Out_AlphaClip4_g158308 = 0;
				float Out_AlphaFade4_g158308 = 0;
				float3 Out_Translucency4_g158308 = float3( 0,0,0 );
				float Out_Transmission4_g158308 = 0;
				float Out_Thickness4_g158308 = 0;
				float Out_Diffusion4_g158308 = 0;
				Out_Dummy4_g158308 = Data4_g158308.Dummy;
				Out_Albedo4_g158308 = Data4_g158308.Albedo;
				Out_NormalTS4_g158308 = Data4_g158308.NormalTS;
				Out_NormalWS4_g158308 = Data4_g158308.NormalWS;
				Out_Shader4_g158308 = Data4_g158308.Shader;
				Out_Emissive4_g158308= Data4_g158308.Emissive;
				Out_MultiMask4_g158308 = Data4_g158308.MultiMask;
				Out_Grayscale4_g158308 = Data4_g158308.Grayscale;
				Out_Luminosity4_g158308= Data4_g158308.Luminosity;
				Out_AlphaClip4_g158308 = Data4_g158308.AlphaClip;
				Out_AlphaFade4_g158308 = Data4_g158308.AlphaFade;
				Out_Translucency4_g158308 = Data4_g158308.Translucency;
				Out_Transmission4_g158308 = Data4_g158308.Transmission;
				Out_Thickness4_g158308 = Data4_g158308.Thickness;
				Out_Diffusion4_g158308 = Data4_g158308.Diffusion;
				half3 Input_Albedo24_g158306 = Out_Albedo4_g158308;
				#ifdef UNITY_COLORSPACE_GAMMA
				float4 staticSwitch22_g158306 = half4(0.2209163,0.2209163,0.2209163,0.7790837);
				#else
				float4 staticSwitch22_g158306 = half4(0.04,0.04,0.04,0.96);
				#endif
				half4 ColorSpaceDielectricSpec23_g158306 = staticSwitch22_g158306;
				float4 break24_g158305 = Out_Shader4_g158308;
				half Metallic117_g158305 = break24_g158305.x;
				half Input_Metallic25_g158306 = Metallic117_g158305;
				half OneMinusReflectivity31_g158306 = ( (ColorSpaceDielectricSpec23_g158306).w - ( (ColorSpaceDielectricSpec23_g158306).w * Input_Metallic25_g158306 ) );
				float3 lerpResult87_g158305 = lerp( half3(1,0,0) , ( Input_Albedo24_g158306 * OneMinusReflectivity31_g158306 ) , _IsInitialized);
				
				float3 lerpResult28_g158306 = lerp( (ColorSpaceDielectricSpec23_g158306).xyz , Input_Albedo24_g158306 , Input_Metallic25_g158306);
				half RenderSpec105_g158305 = _RenderSpecular;
				

				surfaceDescription.Albedo = lerpResult87_g158305;
				o.Normal = Out_NormalWS4_g158308;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = ( lerpResult28_g158306 * RenderSpec105_g158305 );
				#endif

				surfaceDescription.Emission = (Out_Emissive4_g158308).xyz;
				surfaceDescription.Smoothness = break24_g158305.w;
		...
		Pass
		{
			...
			struct PackedVaryingsMeshToPS
			{
				float4 positionCS : SV_Position;
				UNITY_VERTEX_INPUT_INSTANCE_ID
				float4 UVsFrame122_g156801 : TEXCOORD0;
				float4 UVsFrame222_g156801 : TEXCOORD1;
				float4 UVsFrame322_g156801 : TEXCOORD2;
				float4 octaframe22_g156801 : TEXCOORD3;
				float4 viewPos22_g156801 : TEXCOORD4;
			};
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS Vert( AttributesMesh inputMesh  )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord6.xyz = vertexToFrag281_g157123;
			...
			float4 Frag( PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 In_PositionAddOS16_g157131 = float3( 0,0,0 );
				float3 In_PivotOS16_g157131 = float3( 0,0,0 );
				float3 vertexToFrag281_g157123 = packedInput.ase_texcoord6.xyz;
				half3 Model_PivotWS121_g157123 = vertexToFrag281_g157123;
				float3 In_PivotWS16_g157131 = Model_PivotWS121_g157123;
				half3 Model_PivotWO133_g157123 = ( Model_PivotWS121_g157123 - TVE_WorldOrigin );
				float3 In_PivotWO16_g157131 = Model_PivotWO133_g157123;
		...
		Pass
		{
			...
			struct PackedVaryingsMeshToPS
			{
				...
				float4 UVsFrame122_g156801 : TEXCOORD8;
				float4 UVsFrame222_g156801 : TEXCOORD9;
				float4 UVsFrame322_g156801 : TEXCOORD10;
				float4 octaframe22_g156801 : TEXCOORD11;
				float4 viewPos22_g156801 : TEXCOORD12;
			...
			PackedVaryingsMeshToPS Vert(AttributesMesh inputMesh )
			{
				...
				outputPackedVaryingsMeshToPS.ase_texcoord13.xyz = vertexToFrag281_g157123;
			...
			)
			{
				...
				float3 In_PositionAddOS16_g157131 = float3( 0,0,0 );
				float3 In_PivotOS16_g157131 = float3( 0,0,0 );
				float3 vertexToFrag281_g157123 = packedInput.ase_texcoord13.xyz;
				half3 Model_PivotWS121_g157123 = vertexToFrag281_g157123;
				float3 In_PivotWS16_g157131 = Model_PivotWS121_g157123;
				half3 Model_PivotWO133_g157123 = ( Model_PivotWS121_g157123 - TVE_WorldOrigin );
				float3 In_PivotWO16_g157131 = Model_PivotWO133_g157123;
		...
		Pass
		{
			...
			struct PackedVaryingsToPS
			{
				...
				float4 UVsFrame122_g156801 : TEXCOORD3;
				float4 UVsFrame222_g156801 : TEXCOORD4;
				float4 UVsFrame322_g156801 : TEXCOORD5;
				float4 octaframe22_g156801 : TEXCOORD6;
				float4 viewPos22_g156801 : TEXCOORD7;
			...
			PackedVaryingsToPS Vert(AttributesMesh inputMesh, AttributesPass inputPass  )
			{
				...
				TVEModelData Data16_g157130 = (TVEModelData)0;
				float In_Dummy16_g157130 = 0.0;
				OctaImpostorVertex( inputMesh.positionOS, inputMesh.normalOS, outputPackedVaryingsToPS.UVsFrame122_g156801, outputPackedVaryingsToPS.UVsFrame222_g156801, outputPackedVaryingsToPS.UVsFrame322_g156801, outputPackedVaryingsToPS.octaframe22_g156801, outputPackedVaryingsToPS.viewPos22_g156801 );
				float3 worldPosOut22_g156801 = GetAbsolutePositionWS( mul( UNITY_MATRIX_I_V, float4( outputPackedVaryingsToPS.viewPos22_g156801.xyz, 1.0 ) ).xyz );
				half3 Input_PositionWS218_g157123 = worldPosOut22_g156801;
				float3 worldToObj278_g157123 = mul( GetWorldToObjectMatrix(), float4( GetCameraRelativePositionWS(Input_PositionWS218_g157123), 1 ) ).xyz;
				half3 Model_PositionOS131_g157123 = worldToObj278_g157123;
				float3 In_PositionOS16_g157130 = Model_PositionOS131_g157123;
				...
				outputPackedVaryingsToPS.ase_texcoord9.xyz = vertexToFrag281_g157123;
				outputPackedVaryingsToPS.ase_texcoord10.xyz = ase_worldNormal;
				...
				outputPackedVaryingsToPS.ase_texcoord10.w = 0;
				inputMesh.positionOS.xyz += staticSwitch14_g158319.rgb;
			...
			)
			{
				...
				float3 In_PositionAddOS16_g157131 = float3( 0,0,0 );
				float3 In_PivotOS16_g157131 = float3( 0,0,0 );
				float3 vertexToFrag281_g157123 = packedInput.ase_texcoord9.xyz;
				half3 Model_PivotWS121_g157123 = vertexToFrag281_g157123;
				float3 In_PivotWS16_g157131 = Model_PivotWS121_g157123;
				half3 Model_PivotWO133_g157123 = ( Model_PivotWS121_g157123 - TVE_WorldOrigin );
				float3 In_PivotWO16_g157131 = Model_PivotWO133_g157123;
				float3 In_NormalOS16_g157131 = float3( 0,0,0 );
				float3 ase_worldNormal = packedInput.ase_texcoord10.xyz;
				half3 Model_Normal_WS95_g157123 = ase_worldNormal;
				float3 In_NormalWS16_g157131 = Model_Normal_WS95_g157123;
				float3 In_NormalRawOS16_g157131 = float3( 0,0,0 );
				float3 In_NormalRawWS16_g157131 = float3( 0,0,0 );
		...
		Pass
        {
			...
			struct PackedVaryingsMeshToPS
			{
				...
				float4 interp04 : TEXCOORD4;
				float4 interp05 : TEXCOORD5;
				float4 UVsFrame122_g156801 : TEXCOORD6;
				float4 UVsFrame222_g156801 : TEXCOORD7;
				float4 UVsFrame322_g156801 : TEXCOORD8;
				float4 octaframe22_g156801 : TEXCOORD9;
				float4 viewPos22_g156801 : TEXCOORD10;
				float4 ase_texcoord11 : TEXCOORD11;
				UNITY_VERTEX_INPUT_INSTANCE_ID
				UNITY_VERTEX_OUTPUT_STEREO
			};
...
Node;AmplifyShaderEditor.FunctionNode;481;-8064,0;Inherit;False;Block Impostor Model;35;;157123;93e44146af3144a4b84056ae65ecf0fc;0;2;288;COLOR;0,0,0,0;False;163;FLOAT3;0,0,0;False;2;OBJECT;128;OBJECT;339
Node;AmplifyShaderEditor.RegisterLocalVarNode;482;-7744,64;Half;False;Model Frag;-1;True;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.GetLocalVarNode;483;-7296,-256;Inherit;False;482;Model Frag;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.FunctionNode;484;-7040,-256;Inherit;False;Block Lite Global;40;;157132;3cde0aa66f3d8ec4a9b80a215a26f02b;16,315,1,311,1,317,1,321,1,319,1,323,1,337,1,283,1,285,1,282,1,308,1,276,1,349,1,287,1,289,1,348,1;1;206;OBJECT;0,0,0,0;False;1;OBJECT;151
Node;AmplifyShaderEditor.FunctionNode;485;-8064,-256;Inherit;False;Block Impostor Visual;102;;157197;f5a6295b5f4a3004ebbb03db403bc544;0;5;229;COLOR;0,0,0,0;False;285;COLOR;0,0,0,0;False;224;FLOAT3;0,0,0;False;217;FLOAT3;0,0,0;False;261;FLOAT;0;False;1;OBJECT;272
Node;AmplifyShaderEditor.RegisterLocalVarNode;486;-7744,-256;Half;False;Visual  Raw;-1;True;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;487;-6720,-256;Half;False;Global Data;-1;True;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.GetLocalVarNode;488;-4864,-256;Inherit;False;486;Visual  Raw;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.GetLocalVarNode;489;-4864,-128;Inherit;False;487;Global Data;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;490;-7744,0;Half;False;Model Vert;-1;True;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.GetLocalVarNode;491;-4480,-128;Inherit;False;487;Global Data;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.FunctionNode;492;-4480,-256;Inherit;False;Block Lite Overlay;177;;158217;df6d6bbf01172a34387d93d862d3d156;9,821,0,819,0,813,0,908,0,826,1,823,1,828,0,844,0,447,0;4;572;OBJECT;0,0,0,0;False;596;OBJECT;0,0,0,0;False;600;OBJECT;0,0,0,0;False;445;FLOAT;1;False;1;OBJECT;566
Node;AmplifyShaderEditor.GetLocalVarNode;493;-6272,-256;Inherit;False;490;Model Vert;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.GetLocalVarNode;494;-4096,-64;Inherit;False;487;Global Data;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.FunctionNode;495;-4096,-256;Inherit;False;Block Emissive;277;;158247;64497f287b9096b43b688b52b4a0bf20;5,282,0,273,0,275,0,264,0,267,0;3;146;OBJECT;0,0,0,0;False;148;OBJECT;0,0,0,0;False;178;OBJECT;0,0,0,0;False;1;OBJECT;183
Node;AmplifyShaderEditor.GetLocalVarNode;496;-4096,-128;Inherit;False;482;Model Frag;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.FunctionNode;497;-6016,-256;Inherit;False;Block Lite Impostor Motion;331;;158262;38077585734a3224db90527d4119d9c6;0;2;146;OBJECT;0,0,0,0;False;212;OBJECT;0,0,0,0;False;1;OBJECT;128
...
Node;AmplifyShaderEditor.FunctionNode;430;-2944,128;Inherit;False;Block Lite Size Fade;320;;158283;828b7cb552f180f4193fb67dbaaae0ce;0;0;1;COLOR;128
Node;AmplifyShaderEditor.FunctionNode;425;-2944,64;Inherit;False;Block Lite Dithering;261;;158284;6e52cef07120daa408f9658182b29574;3,847,0,848,0,855,1;0;1;COLOR;566
Node;AmplifyShaderEditor.FunctionNode;427;-2944,-192;Inherit;False;Block Lite Tinting;122;;158285;c2bee839afbcbb7499ebde2af2a2b317;3,352,0,377,0,375,0;0;1;COLOR;204
Node;AmplifyShaderEditor.FunctionNode;428;-2944,-128;Inherit;False;Block Lite Dryness;148;;158286;d0ad841a44e589843b633cc1b97af190;3,398,0,440,0,438,0;0;1;COLOR;346
Node;AmplifyShaderEditor.FunctionNode;429;-2944,0;Inherit;False;Block Lite Cutout;244;;158287;0780bee94024ab547ae8bb1fac250cb1;2,775,0,824,0;0;1;COLOR;566
Node;AmplifyShaderEditor.FunctionNode;446;-2944,-64;Inherit;False;Block Lite Wetness;224;;158288;30361f2d9d7742e4db0b62746ed1affc;3,850,0,877,0,873,0;0;1;COLOR;566
Node;AmplifyShaderEditor.FunctionNode;498;-3712,-256;Inherit;False;Block Subsurface;301;;158290;d738d295ada6b1f409db6776b5efe789;3,315,1,359,1,362,0;4;146;OBJECT;0,0,0,0;False;385;OBJECT;0,0,0,0;False;371;OBJECT;0,0,0,0;False;361;FLOAT;1;False;1;OBJECT;183
Node;AmplifyShaderEditor.FunctionNode;499;-5632,-256;Inherit;False;Block Transform;-1;;158297;5ac6202bdddd8b34a85c261af6b8de8b;0;1;146;OBJECT;0,0,0,0;False;1;OBJECT;128
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;500;-3392,-256;Half;False;Visual Data;-1;True;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;501;-5312,-256;Half;False;Model Data;-1;True;1;0;OBJECT;;False;1;OBJECT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;435;-1664,-256;Inherit;False;500;Visual Data;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.GetLocalVarNode;434;-1664,-192;Inherit;False;501;Model Data;1;0;OBJECT;;False;1;OBJECT;0
Node;AmplifyShaderEditor.GetLocalVarNode;437;-1408,320;Inherit;False;433;Dummy Data;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;465;-1408,-256;Inherit;False;Block Impostor Render;0;;158305;1dac90ed7ee26b743a17d6c74e115d86;0;2;17;OBJECT;;False;19;OBJECT;;False;19;FLOAT3;21;FLOAT3;83;FLOAT3;34;FLOAT3;77;FLOAT;27;FLOAT;114;FLOAT;113;FLOAT;72;FLOAT;28;FLOAT;71;FLOAT3;65;FLOAT;66;FLOAT;67;FLOAT;68;FLOAT;73;FLOAT3;37;FLOAT3;30;FLOAT3;32;FLOAT4;33
Node;AmplifyShaderEditor.FunctionNode;442;-384,-768;Inherit;False;Base Compile;-1;;158318;e67c8238031dbf04ab79a5d4d63d1b4f;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;445;-1024,128;Inherit;False;Register;-1;;158319;673534ff3248b7442a6471d786096f1f;0;2;6;FLOAT3;0,0,0;False;7;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;444;-608,-768;Half;False;Property;_IsLiteShader;_IsLiteShader;360;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;443;-832,-768;Half;False;Property;_IsStandardShader;_IsStandardShader;359;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;438;-1056,-768;Half;False;Property;_IsImpostorShader;_IsImpostorShader;358;1;[HideInInspector];Create;True;0;2;Opaque;0;Transparent;1;0;True;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;439;-1664,-640;Half;False;Property;_render_coverage;_render_coverage;361;1;[Enum];Create;True;0;1;Off;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;471;-640,-256;Float;False;True;-1;2;TVEShaderGUILite;0;23;BOXOPHOBIC/The Visual Engine/Impostors/Octa Standard Lit (Lite);4e5791d7c677cf540a160f0a09e2385a;True;GBuffer;0;0;GBuffer;27;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;9;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;ps5;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;True;_LightLayersMaskBuffer4;False;False;False;False;False;False;False;True;True;10;False;;255;False;;14;False;;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;1;LightMode=GBuffer;False;False;0;;0;0;Standard;16;Material Type,InvertActionOnDeselection;4;0;Energy Conserving Specular,InvertActionOnDeselection;1;638519777060604685;  Transmission,InvertActionOnDeselection;0;0;Surface Type;0;0;Alpha Cutoff;0;0;Receive Decals;1;0;Receives SSR;1;0;Specular AA;0;0;Specular Occlusion Mode;0;0;Distortion;0;0;Distortion Mode;0;0;Distortion Depth Test;0;0;Blend Preserves Specular;1;0;Fog;1;0;Draw Before Refraction;0;0;Refraction Model;0;0;0;7;True;True;True;True;True;True;True;False;;True;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;472;-640,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;SceneSelectionPass;0;1;SceneSelectionPass;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;473;-640,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;META;0;2;META;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;474;-640,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;ShadowCaster;0;3;ShadowCaster;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;475;-640,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;DepthOnly;0;4;DepthOnly;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;476;-640,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;Motion Vectors;0;5;Motion Vectors;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;40;False;;255;False;;40;False;;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;477;-640,-256;Float;False;False;-1;2;ASEMaterialInspector;0;1;New Amplify Shader;4e5791d7c677cf540a160f0a09e2385a;True;Forward;0;6;Forward;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;8;d3d11;metal;vulkan;xboxone;xboxseries;playstation;ps4;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVelOne;False;True;True;True;True;True;0;True;_ColorMaskTransparentVelTwo;False;False;False;True;True;10;False;;255;False;;14;False;;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;1;LightMode=Forward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
WireConnection;481;163;469;27
WireConnection;482;0;481;339
WireConnection;484;206;483;0
WireConnection;485;229;469;0
WireConnection;485;285;469;23
WireConnection;485;224;469;25
WireConnection;485;217;469;26
WireConnection;486;0;485;272
WireConnection;487;0;484;151
WireConnection;490;0;481;128
WireConnection;492;572;488;0
WireConnection;492;600;489;0
WireConnection;495;146;492;566
WireConnection;495;178;491;0
WireConnection;497;146;493;0
WireConnection;498;146;495;183
WireConnection;498;385;496;0
WireConnection;498;371;494;0
WireConnection;499;146;497;128
WireConnection;432;0;426;116
WireConnection;432;1;427;204
WireConnection;432;2;428;346
WireConnection;432;3;446;566
WireConnection;432;4;429;566
WireConnection;432;5;425;566
WireConnection;432;6;430;128
WireConnection;500;0;498;183
WireConnection;501;0;499;128
WireConnection;433;0;432;0
WireConnection;465;17;435;0
WireConnection;465;19;434;0
WireConnection;445;6;465;37
WireConnection;445;7;437;0
WireConnection;471;0;465;21
WireConnection;471;1;465;83
WireConnection;471;5;465;77
WireConnection;471;6;465;34
WireConnection;471;7;465;27
WireConnection;471;11;445;0
ASEEND*/
//CHKSM=D4D6468A9E11D845D50EC29655848FCD1C9A1AC8